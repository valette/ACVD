/*=========================================================================
  ...
  Module:    vtkMyMinimalStandardRandomSequence.cxx
...
vtkStandardNewMacro(vtkMyMinimalStandardRandomSequence);
...
// ----------------------------------------------------------------------------
vtkMyMinimalStandardRandomSequence::vtkMyMinimalStandardRandomSequence()
{
  this->Seed=1;
}
...
// ----------------------------------------------------------------------------
void vtkMyMinimalStandardRandomSequence::SetSeedOnly(int value)
{
  this->Seed=value;
...
// ----------------------------------------------------------------------------
void vtkMyMinimalStandardRandomSequence::SetSeed(int value)
{
...
// ----------------------------------------------------------------------------
int vtkMyMinimalStandardRandomSequence::GetSeed(void)
{
  return this->Seed;
}

// ----------------------------------------------------------------------------
double vtkMyMinimalStandardRandomSequence::GetValue()
{
...
// ----------------------------------------------------------------------------
void vtkMyMinimalStandardRandomSequence::Next()
{
...
// ----------------------------------------------------------------------------
double vtkMyMinimalStandardRandomSequence::GetRangeValue(double rangeMin,
                                                       double rangeMax)
{
  double result;
...
// ----------------------------------------------------------------------------
void vtkMyMinimalStandardRandomSequence::PrintSelf(ostream& os, vtkIndent indent)
{
