/*=========================================================================
  ...
  Module:    vtkMyMinimalStandardRandomSequence.h
...
=========================================================================*/
// .NAME vtkMyMinimalStandardRandomSequence - Park and Miller Sequence of pseudo random numbers
// .SECTION Description
// vtkMyMinimalStandardRandomSequence is a sequence of statistically independent
...
#ifndef __vtkMyMinimalStandardRandomSequence_h
#define __vtkMyMinimalStandardRandomSequence_h
#include <vtkObject.h>
...
//  vtkTypeMacro(vtkMyMinimalStandardRandomSequence,vtkRandomSequence);
  ...
  static vtkMyMinimalStandardRandomSequence* New();
...
protected:
  vtkMyMinimalStandardRandomSequence();
  virtual ~vtkMyMinimalStandardRandomSequence();
  int Seed;
private:
  vtkMyMinimalStandardRandomSequence(const vtkMyMinimalStandardRandomSequence&);  // Not implemented.
  void operator=(const vtkMyMinimalStandardRandomSequence&);  // Not implemented.
};

#endif // #ifndef __vtkMyMinimalStandardRandomSequence_h
